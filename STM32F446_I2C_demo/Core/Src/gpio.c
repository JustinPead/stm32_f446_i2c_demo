...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LCD_RS_Pin|LCD_E_Pin|SPI2_NSS_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LCD_RS_Pin|LCD_E_Pin|SPI2_NSS_Pin;
  ...
  GPIO_InitStruct.Pin = PUSH0_Pin|PUSH1_Pin|PUSH2_Pin|PUSH3_Pin;
